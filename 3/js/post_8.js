...
var as3 = '<div class="l3_as" align="center"><amp-ad width="100vw" height="320" type="adsense" data-ad-client="ca-pub-4881038805263910" data-ad-slot="8744395659" data-auto-format="rspv" data-full-width=""><div overflow=""></div></amp-ad></div>';
$("<p/>").insertAfter("#as_1a").replaceWith(as1),$("<p/>").insertAfter("#as_2a").replaceWith(as2),$("<p/>").insertAfter("#as_3a").replaceWith(as3),$("<p/>").insertBefore("#as_1b").replaceWith(as1),$("<p/>").insertBefore("#as_2b").replaceWith(as2),$("<p/>").insertBefore("#as_3b").replaceWith(as3),$("<p/>").insertAfter(".as_1a").replaceWith(as1),$("<p/>").insertAfter(".as_2a").replaceWith(as2),$("<p/>").insertAfter(".as_3a").replaceWith(as3),$("<p/>").insertBefore(".as_1b").replaceWith(as1),$("<p/>").insertBefore(".as_2b").replaceWith(as2),$("<p/>").insertBefore(".as_3b").replaceWith(as3);
